...
const artifacts = [
  { atk: 408, critRate: 0.521, critDmg: 0.241, elemDmg: 0.12, elemMast: 560 },
];
...
export const print = () => {
  ...
  console.log(
    `Sac sword: ${damageDps(
      ...
      breezeHits(buffs, debuffs, undefined, transforms, undefined)
    )}`
  );
  console.log(
  ...
  console.log(
    `Sac sword: ${damageDps(
      ...sunfireVapeTest(stats(char, sacSword, artifacts)),
      8
    )}`
  );
  console.log(
    `Iron sting: ${damageDps(
      ...sunfireVapeTest(stats(char, ironSting, artifacts)),
      8
    )}`
  );
  ...
  console.log(
    `Sac sword: ${damageDps(
      ...sunfireOvervapeTest(stats(char, sacSword, artifacts)),
      8
    )}`
  );
  console.log(
    `Iron sting: ${damageDps(
      ...sunfireOvervapeTest(stats(char, ironSting, artifacts)),
      8
    )}`
  );
  ...
  console.log(
    `Sac sword: ${damageDps(
      ...sunfireOvervapeTest(stats(char, sacSword, artifacts), 1)
    )}`
  );
  console.log(
    `Iron sting: ${damageDps(
      ...sunfireOvervapeTest(stats(char, ironSting, artifacts), 1)
    )}`
  );
};
