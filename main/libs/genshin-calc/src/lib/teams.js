...
import { setCurrentTeam } from './team.js';
...
export const yoimiya_yelan_xingqiu_bennett = () => {
    ...
    output(`Yoimiya, Yelan, Xingqiu, Bennett: ${teamDamageDps([
        firedanceAction,
        xingqiu.raincutterAction({
            weapon: sacSword,
            artifacts: [flower_1, feather_9, sand_1, goblet_1, circlet_37],
...
export const yoimiya_yelan_xingqiu_zhongli = () => {
    ...
    output(`Yoimiya, Yelan, Xingqiu, Zhong Li: ${teamDamageDps([
        firedanceAction,
        xingqiu.raincutterAction({
            weapon: sacSword,
            artifacts: [flower_1, feather_9, sand_1, goblet_1, circlet_37],
...
export const yoimiya_yelan_fischl_zhongli = () => {
    ...
    output(`Yoimiya, Yelan, Fischl, Zhong Li: ${teamDamageDps([
        firedanceAction,
        yelan.diceAction({
            weapon: skywardHarpR1,
            artifacts: [flower_52, feather_36, sand_52, goblet_52, circlet_52],
...
export const yoimiya_yelan_yae_zhongli = () => {
    ...
    output(`Yoimiya, Yelan, Yae, Zhong Li: ${teamDamageDps([
        firedanceAction,
        yelan.diceAction({
            weapon: skywardHarpR1,
            artifacts: [flower_52, feather_36, sand_52, goblet_52, circlet_52],
...
export const hutao_yelan_xingqiu_zhongli = () => {
    ...
    output(`Hutao, Yelan, Xingqiu, Zhong Li: ${teamDamageDps([
        afterlifeAction, 
        xingqiu.raincutterAction({
            weapon: sacSword,
            artifacts: [flower_1, feather_9, sand_1, goblet_1, circlet_37],
...
export const eula_fischl_lisa_diona = () => {
    ...
    output(`Eula, Fischl, Lisa, Diona: ${teamDamageDps([{
        ...
        char: stats(fischl.char, stringlessR5, [flower_13, feather_16, sand_13, goblet_15, circlet_45]),
...
export const xingqiu_yelan_xiangling_bennett = () => {
    ...
    output(`Xingqiu, Yelan, Xiangling, Bennett: ${teamDamageDps([
        xingqiu.raincutterAction({
            weapon: sacSword,
            artifacts: [flower_1, feather_9, sand_1, goblet_1, circlet_37],
            buffs: onField,
...
export const xingqiu_yelan_xiangling_zhongli = () => {
    ...
    output(`Xingqiu, Yelan, Xiangling, Zhongli: ${teamDamageDps([
        xingqiu.raincutterAction({
            weapon: sacSword,
            artifacts: [flower_1, feather_9, sand_1, goblet_1, circlet_37],
            buffs: onField,
...
export const itto_yae_albedo_gorou = () => {
    ...
    output(`Itto, Yae, Albedo, Gorou: ${teamDamageDps([
        royalAction,
        albedo.blossomAction({
            weapon: cinnabar,
            buffs: teamWide,
...
export const ayaka_yelan_xingqiu_shenhe = () => {
    ...
    output(`Ayaka, Yelan, Xingqiu, Shenhe: ${teamDamageDps([
        soumetsuAction,
        ayaka.comboAction({
            weapon: amenoma,
            debuffs,
...
export const ayato_ayaka_shenhe_jean = () => {
    ...
    output(`Ayato, Ayaka, Shenhe, Jean: ${teamDamageDps([
        soumetsuAction,
        ayato.suiyuuAction({
            weapon: skywardBlade,
            buffs: onField,
...
export const ayato_yunjin_albedo_gorou = () => {
    ...
    output(`Ayato, Yunjin, Albedo, Gorou: ${teamDamageDps([
        ayato.suiyuuAction({
            weapon: skywardBlade,
            buffs: onField,
            debuffs,
...
export const ayato_yae_albedo_jean = () => {
    ...
    output(`Ayato, Yae, Albedo, Jean: ${teamDamageDps([
        ayato.suiyuuAction({
            weapon: skywardBlade,
            buffs: onField,
            debuffs,
...
export const ayato_yae_sara_zhongli = () => {
    ...
    output(`Ayato, Yae, Sara, Zhong Li: ${teamDamageDps([
        ayato.suiyuuAction({
            weapon: skywardBlade,
            buffs: onField,
            debuffs,
...
export const ayato_yae_fischl_jean = () => {
    ...
    output(`Ayato, Yae, Fischl, Jean: ${teamDamageDps([
        ayato.suiyuuAction({
            weapon: skywardBlade,
            buffs: onField,
            debuffs,
...
export const ayato_yae_fischl_mona = () => {
    ...
    output(`Ayato, Yae, Fischl, Mona: ${teamDamageDps([
        ayato.suiyuuAction({
            weapon: skywardBlade,
            buffs: onField,
            debuffs,
...
export const ayato_yae_bennett_sara = () => {
    ...
    output(`Ayato, Yae, Bennett, Sara: ${teamDamageDps([
        ayato.suiyuuAction({
            weapon: skywardBlade,
            buffs: onField,
            debuffs,
...
export const ayato_yae_bennett_xinyan = () => {
    ...
    output(`Ayato, Yae, Bennett, Xinyan: ${teamDamageDps([
        ayato.suiyuuAction({
            weapon: skywardBlade,
            buffs: onField,
            debuffs,
...
export const ayato_fischl_bennett_sara = () => {
    ...
    output(`Ayato, Fischl, Bennett, Sara: ${teamDamageDps([
        ayato.suiyuuAction({
            weapon: skywardBlade,
            buffs: onField,
            debuffs,
...
export const ayato_yae_bennett_jean = () => {
    ...
    output(`Ayato, Yae, Bennett, Jean: ${teamDamageDps([
        ayato.suiyuuAction({
            weapon: skywardBlade,
            buffs: onField,
            debuffs,
...
export const ayato_yunjin_bennett_sucrose = () => {
    ...
    output(`Ayato, Yunjin, Bennett, Sucrose: ${teamDamageDps([
        ayato.suiyuuAction({
            weapon: skywardBlade,
            buffs: onField,
            debuffs,
...
export const ayato_xiangling_yae_bennett = () => {
    ...
    output(`Ayato, Xiangling, Yae, Bennett: ${teamDamageDps([
        ayato.suiyuuAction({
            weapon: skywardBlade,
            buffs: onField,
            debuffs,
...
export const ayato_mona_yae_jean = () => {
    ...
    output(`Ayato, Mona, Yae, Jean: ${teamDamageDps([
        ayato.suiyuuAction({
            weapon: skywardBlade,
            buffs: onField,
            debuffs,
...
export const ayato_xingqiu_yae_albedo = () => {
    const teamWide = [homNature, xingqiuC2];
    const onField = [...teamWide];
    const debuffs = [xingqiuC2];

    output(`Ayato, Xingqiu, Yae, Albedo: ${teamDamageDps([
        ayato.suiyuuAction({
            weapon: skywardBlade,
            buffs: onField,
            debuffs,
...
export const ayato_xingqiu_yunjin_bennett = () => {
    ...
    output(`Ayato, Xingqiu, Yunjin, Bennett: ${teamDamageDps([
        ayato.suiyuuAction({
            weapon: skywardBlade,
            buffs: onField,
            debuffs,
