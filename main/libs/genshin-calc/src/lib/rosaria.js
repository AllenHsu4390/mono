...
const confessionHits = (
  ...
  return [0.876, 2.04].map((motionValue, index) => {
    return {
...
const terminationHits = (
  ...
  return [1.664, 2.432]
    .concat(Array(duration).fill(2.112))
...
export const terminationAction = ({
  weapon,
  artifacts,
  buffs,
  debuffs,
...
export const print = () => {
  withContext({
    ...
    run: () => {
      ...
      console.log(
        `Deathmatch: ${damageDps(
          stats(rosaria, deathmatch1, artifacts),
          confessionHits(
            [...buffs, makeShenheE(2, 4200)],
            debuffs,
            amps,
            undefined,
            undefined
      ...
      console.log(
        `Kitain: ${damageDps(
          stats(rosaria, kitain, artifacts),
          confessionHits(
            [...buffs, makeShenheE(2, 4200)],
            debuffs,
            amps,
      ...
      console.log(
        `Dragon bane: ${damageDps(
          stats(rosaria, dragonsBane, artifacts),
          confessionHits(
            [...buffs, makeShenheE(2, 4200)],
            debuffs,
            amps,
      ...
      console.log(
        `wavebreaker: ${damageDps(
          stats(rosaria, wavebreakerR3, artifacts),
          confessionHits(
            [...buffs, makeShenheE(2, 4200)],
            debuffs,
            amps,
      ...
      console.log(
        `Deathmatch: ${damageDps(
          stats(rosaria, deathmatch1, artifacts.concat({ critRate: 1 })),
          terminationHits(
            [...buffs, makeShenheE(5, 4200)],
            debuffs,
            amps,
      ...
      console.log(
        `Kitain: ${damageDps(
          stats(rosaria, kitain, artifacts.concat({ critRate: 1 })),
          terminationHits(
            [...buffs, makeShenheE(5, 4200)],
            debuffs,
            amps,
      ...
      console.log(
        `Dragon bane: ${damageDps(
          stats(rosaria, dragonsBane, artifacts.concat({ critRate: 1 })),
          terminationHits(
            [...buffs, makeShenheE(5, 4200)],
            debuffs,
            amps,
      ...
      console.log(
        `wavebreaker: ${damageDps(
          stats(rosaria, wavebreakerR3, artifacts.concat({ critRate: 1 })),
          terminationHits(
            [...buffs, makeShenheE(5, 4200)],
            debuffs,
            amps,
      ...
      console.log(
        `Homa: ${damageDps(
          stats(rosaria, homa, artifacts.concat({ critRate: 1 })),
          terminationHits(
            [...buffs, makeShenheE(5, 4200)],
            debuffs,
            amps,
