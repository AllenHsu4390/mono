...
export const print = () => {
    const hits = soumetsuHits;
    setCurrentEnemy(enemy);
    console.log(`HOD Soumetsu Damage: ${damageDps(stats(char, harbinger, artifacts), hits(buffs, debuffs, undefined, undefined, undefined))}`);
    console.log(`Amenoma Soumetsu Damage: ${damageDps(stats(char, amenoma, artifacts), hits(buffs, debuffs, undefined, undefined, undefined))}`);
    console.log('-----CRIT 1 Cut-----');
    console.log(`HOD Soumetsu Damage: ${damageDps(stats(char, harbinger, artifacts.concat({ critRate: 1 })), hits(buffs, debuffs, undefined, undefined, undefined).slice(1, 2))}`);
    console.log(`Amenoma Soumetsu Damage: ${damageDps(stats(char, amenoma, artifacts.concat({ critRate: 1 })), hits(buffs, debuffs, undefined, undefined, undefined).slice(1, 2))}`);
    console.log('-----Shenhe Buff-----');
    console.log(`HOD Soumetsu Damage: ${damageDps(stats(char, harbinger, artifacts), hits([...buffs, makeShenheE(10)], [...debuffs, shenheBurst], undefined, undefined, undefined))}`);
    console.log(`Amenoma Soumetsu Damage: ${damageDps(stats(char, amenoma, artifacts), hits([...buffs, makeShenheE(10)], [...debuffs, shenheBurst], undefined, undefined, undefined))}`);
    console.log('-----Shenhe Buff CRIT 1 Cut-----');
    console.log(`HOD Soumetsu Damage: ${damageDps(stats(char, harbinger, artifacts.concat({ critRate: 1 })), hits([...buffs, makeShenheE(1)], [...debuffs, shenheBurst], undefined, undefined, undefined).slice(1, 2))}`);
    console.log(`Amenoma Soumetsu Damage: ${damageDps(stats(char, amenoma, artifacts.concat({ critRate: 1 })), hits([...buffs, makeShenheE(1)], [...debuffs, shenheBurst], undefined, undefined, undefined).slice(1, 2))}`);
};